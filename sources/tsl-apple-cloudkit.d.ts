...
declare module CloudKit
{
	...
	export interface CloudKitConfig
	{
		...
		services?: {
			...
			/**
			 * An object with methods info, log, warn, and error. You can set
			 * this object to window.console.
			 */
			logger?: {
				error?: Function;
				info?: Function;
	...
	{
		/**
		 * The API token and other authentication properties. Either this key
		 * or the serverToServerKeyAuth key is required. If you include this
		 * key, don’t include the serverToServerKeyAuth key.
		 */
		apiTokenAuth?: {
			/**
			 * The API token generated and obtained using CloudKit Dashboard
		...
		/**
		 * The Apple Push Notification service (APNs) environment associated
		 * with this container. Possible values are "DEVELOPMENT_ENVIRONMENT"
		 ...
		 * "DEVELOPMENT_ENVIRONMENT" and "PRODUCTION_ENVIRONMENT".
		 */
	...
	export interface ContainerConfigLike
	{
		...
		/**
		 * The server-to-server authentication key and related properties.
		 * Either this key or the apiTokenAuth key is required.
		 * If you include this key, don’t include the apiTokenAuth key.
		 */
		serverToServerKeyAuth?: {
			/**
			 * A unique identifier for the key generated using CloudKit
